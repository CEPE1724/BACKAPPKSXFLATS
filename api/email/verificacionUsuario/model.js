...
const tempValidationCodeSchema = new mongoose.Schema({
    ...
    collection: 'TempValidationCodes' // Especifica el nombre real de la colección en la base de datos
});
...
const TempValidationCodes = mongoose.model('TempValidationCodes', tempValidationCodeSchema);
